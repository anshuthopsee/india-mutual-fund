        ...
        <Box sx={{ mt: "70px" }}>
          ...
          <Box sx={{ width: "100%", px: "15px", mt: "20px", alignItems: "center" }}>
            ...
            <Typography variant='body2' sx={{ color: "text.secondary", textAlign: "justify", pb: "20px" }}>
              This is a simple web app to view the historical NAV of Indian Mutual Funds. 
              You can search for a fund by name and view its historical NAV in a chart and also
              see the percentage change in the NAV over time. A date range selector is available to 
              select and zoom in on a specific time period. The chart was made with D3 and is complete 
              with trasnitions, graidents, and tooltips. The option to download the historical NAV data 
              for any Mutual Fund in CSV format is available. All the Mutual Fund data, including the search 
              results, are fetched from the <Link href="https://www.mfapi.in/" target="_blank" rel="noopener"> MFAPI.in</Link> free API.
            </Typography>
          </Box>
        </Box>
      </Container>
