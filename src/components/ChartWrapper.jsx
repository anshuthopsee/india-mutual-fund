  ...
  return (
    <>
      <Box sx={{ flexGrow: 1, m: "10px" }}>
          <Search />
          <Box sx={{ display: "flex", height: 640, backgroundColor: "background.contrast", borderRadius: "5px", color: "text.secondary", flexDirection: "column" }}>
            <Box sx={{ display: "flex", px: "8px", alignItems: "center", height: "50px", borderBottom: 1, borderBottomColor: "border.secondary", justifyContent: "space-between" }}>
              <Typography variant="body1" component="div" sx={{ flexGrow: 1, fontWeight: "bold", mx: "5px" }}>Historical NAV Chart</Typography>
